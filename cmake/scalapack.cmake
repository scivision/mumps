...
set(scalapack_args -DCMAKE_INSTALL_PREFIX:PATH=${SCALAPACK_ROOT}
    -DLAPACK_ROOT:PATH=${LAPACK_ROOT} -DBUILD_SHARED_LIBS:BOOL=false
    -DCMAKE_BUILD_TYPE=Release -DBUILD_TESTING:BOOL=false)
...
ExternalProject_Add(
  ...
  BUILD_BYPRODUCTS ${SCALAPACK_LIBRARIES} INACTIVITY_TIMEOUT 15
