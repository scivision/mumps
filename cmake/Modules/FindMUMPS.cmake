...
function(mumps_check)
  ...
  set(CMAKE_REQUIRED_INCLUDES ${MUMPS_INCLUDE_DIR} ${SCALAPACK_INCLUDE_DIRS}
      ${LAPACK_INCLUDE_DIRS} ${MPI_Fortran_INCLUDE_DIRS} ${MPI_C_INCLUDE_DIRS})
...
function(mumps_libs)
  ...
  # NOTE: NO_DEFAULT_PATH disables CMP0074 MUMPS_ROOT and PATH_SUFFIXES, so we
  # manually specify: HINTS ${MUMPS_ROOT} PATH_SUFFIXES ... to allow MKL using
  # user-built MUMPS with `cmake -DMUMPS_ROOT=~/lib_intel/mumps`
  ...
  if(DEFINED ENV{MKLROOT})
    find_path(
      ...
      NO_DEFAULT_PATH
      HINTS ${MUMPS_ROOT}
      PATH_SUFFIXES include include/${PROJECT_NAME}
  ...
  if(DEFINED ENV{MKLROOT})
    find_library(
      ...
      NO_DEFAULT_PATH
      HINTS ${MUMPS_ROOT}
      PATH_SUFFIXES lib lib/${PROJECT_NAME}
...
if(MUMPS_FOUND)
  ...
  if(NOT TARGET MUMPS::MUMPS)
    ...
    set_target_properties(
      MUMPS::MUMPS
      PROPERTIES INTERFACE_LINK_LIBRARIES "${MUMPS_LIBRARY}"
    ...
    if(OpenMP_FOUND)
      target_link_libraries(MUMPS::MUMPS INTERFACE OpenMP::OpenMP_Fortran
                                                   OpenMP::OpenMP_C)
    endif()
  endif()
  ...
  if(mpiseq IN_LIST MUMPS_FIND_COMPONENTS)
    if(NOT TARGET MUMPS::MPISEQ)
      ...
      set_target_properties(
        MUMPS::MPISEQ
        PROPERTIES INTERFACE_LINK_LIBRARIES "${MUMPS_mpiseq_LIB}"
