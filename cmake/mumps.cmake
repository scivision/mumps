...
endforeach()
if(MUMPS_UPSTREAM_VERSION VERSION_GREATER_EQUAL 4.9)
...
if(MUMPS_UPSTREAM_VERSION VERSION_GREATER_EQUAL 5.0)
  foreach(i IN ITEMS ana_orderings.F ana_set_ordering.F ana_AMDMF.F bcast_errors.F estim_flops.F mumps_type_size.F mumps_type2_blocking.F mumps_version.F mumps_print_defined.F mumps_numa.c tools_common.F)
    list(APPEND COMM_OTHER_SRC ${_s}${i})
  endforeach()
endif()
