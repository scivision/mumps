...
if(ret EQUAL 0)
  message(STATUS "METIS build with ${N} workers")
else()
  message(FATAL_ERROR "METIS failed to configure.")
endif()

execute_process(
COMMAND ${CMAKE_COMMAND} --build ${bindir} --parallel ${N} -t metis
RESULT_VARIABLE ret
)

if(ret EQUAL 0)
  message(STATUS "METIS install complete.")
else()
  message(FATAL_ERROR "METIS failed to build and install.")
endif()
